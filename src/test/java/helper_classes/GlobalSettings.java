...
public final class GlobalSettings {
	...
	private GlobalSettings() {
		...
		try {
			...
			property.load(new FileInputStream(new File("./src/test/resources/properties/AT1006_GlobalSettings.properties")));
			// ./src/test/resources/properties/AT1006_GlobalSettings.properties
